...
}catch(d){}}function imageHotSpots(e,f){var b=this.findParentByType("panel"),h=b.getComponent("text"),j=b.getComponent("tooltipposition"),c=b.getComponent("url"),d=b.getComponent("targetimagepath"),g=b.getComponent("openinnewwindow"),a=b.getComponent("targetalttext");
if(f=="text"){h.show();
j.show();
c.hide();
g.hide();
d.hide();
a.hide()
}else{if(f=="url"){c.show();
g.show();
h.hide();
j.hide();
d.hide();
a.hide()
}else{if(f=="image"){d.show();
a.show();
h.hide();
j.hide();
c.hide();
